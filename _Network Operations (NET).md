...
~~~cmd
@cmd
ping 10.81.1.10             PC Network Adapter
ping 10.81.1.2		    CoreTAAS
ping 10.81.1.4		    CoreBABA
ping 10.81.100.8		CUCM
ping 10.81.81.1		EDGE - INSIDE
ping 200.0.0.81		    EDGE - OUTSIDE
...
conf t
 ...
 int fa0/9
  no switchport
  ip add 10.81.69.69 255.255.255.248
  no shut
  end
~~~
...
conf t
 ...
 int fa0/9
  no switchport
  ip add 10.81.69.73 255.255.255.248
  no shut
  end
~~~
...
!@EDGE
conf t
 ip route 10.81.10.4 255.255.255.255 10.81.81.4
 end
~~~
...
!@EDGE
conf t
 ip route 10.81.100.4  255.255.255.255  ___.___.___.___
 end
~~~
...
!@EDGE
conf t
 ip route 10.81.100.___  255.255.255.255 ___.___.___.___
 end
~~~
...
!@CUCM
conf t
 ip route 10.81.81.1  255.255.255.255 10.81.100.4
 end
~~~
...
~~~
!@cmd
route add 10.0.0.0 mask 255.0.0.0 10.81.1.4 -p
route add 200.0.0.0 mask 255.255.255.0 10.81.1.4 -p
~~~
...
- EDGE loop1 (81.0.0.1/32)
- CoreTAAS loop25 (10.81.25.25/32)
~~~
!@CoreTAAS
conf t
 ip routing
 int loopback 25
  ip add 10.81.25.25 255.255.255.255
  end
~~~
...
!@CoreTAAS
conf t
 ip route 81.0.0.1 255.255.255.255 10.81.1.4
 end
~~~
...
!@EDGE
conf t
 ip route 10.81.25.25 255.255.255.255 10.81.81.4
 end
~~~
...
!@CoreBABA
conf t
 ip route 10.81.25.25 255.255.255.255 10.81.1.2
 ip route 81.0.0.1 255.255.255.255 10.81.81.1
 end
~~~
...
!@CoreTAAS
conf t
 ip route 10.81.81.1 255.255.255.255 10.81.1.4
 end
~~~
...
!@EDGE
conf t
 ip route 10.81.1.2 255.255.255.255 10.81.81.4
 end
~~~
...
conf t
 int loopback 90
  ip add 10.81.90.4 255.255.255.240
  exit
 router eigrp 100
  network 10.81.90.0 0.0.0.15
  network 10.81.1.0 0.0.0.255
  network 10.81.10.0 0.0.0.255
  network 10.81.50.0 0.0.0.255
  network 10.81.100.0 0.0.0.255
  end
~~~
...
conf t
 int loopback 90
  ip add 10.81.90.90 255.255.255.240
  exit
 router eigrp 100
  network 10.81.90.80 0.0.0.15
  network 10.81.100.0 0.0.0.255
  end
~~~
...
conf t
 router ospf 1
  ...
  network 10.81.1.0 0.0.0.255 area 0
...
conf t
 int loopback 110
  ip add 10.81.110.110 255.255.255.255
  ip ospf 1 area 81
  end
...
conf t
 ...
 ip access-list extended NAT-POLICY
  deny ip 10.81.0.0 0.0.255.255 10.11.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.12.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.21.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.22.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.31.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.41.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.42.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.52.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.61.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.62.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.71.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.82.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.91.0.0 0.0.255.255
  deny ip 10.81.0.0 0.0.255.255 10.92.0.0 0.0.255.255
  no deny ip 10.81.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  permit ip any any
  exit
 !
...
conf t
 int tun1
  ip add 172.16.1.81 255.255.255.0
  ...
  no ip nhrp map 172.16.1.81 200.0.0.81
  exit
 ...
 !
 no ip route 10.81.0.0 255.255.0.0 172.16.1.81 252
 end
~~~
...
ifconfig ens256 10.81.1.6 netmask 255.255.255.0 up
~~~
...
~~~
!@NetOps-PH
ip route add 10.0.0.0/8 via 10.81.1.4 dev ens256
ip route add 200.0.0.0/24 via 10.81.1.4 dev ens256
